...
const classes = computed(() => clsx("w-full rounded-[14px] p-5 flex justify-center items-center font-bold text-[1.25rem] cursor-pointer hover:text-[var(--primary-action-color)]",
    {
...
<template>
    <main class="flex justify-between">
        ...
        <section class="flex-1/2 shrink-0 pl-28 flex flex-col items-center gap-6">
            <div :class="classes" @click="$router.push('/topic/1')">
